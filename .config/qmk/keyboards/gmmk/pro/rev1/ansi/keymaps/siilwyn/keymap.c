...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        RGB_TOG, KC_BRID, KC_BRIU, KC_CALC, _______, _______, KC_SLEP, KC_MPRV, _______, KC_MNXT, KC_MUTE, _______, _______, KC_PSCR,          _______,
        ...
        _______, _______, _______,                            _______,                            _______, KC_TRNS, _______, RGB_SPD, RGB_RMOD,RGB_SPI
    ),
